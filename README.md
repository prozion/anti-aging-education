...
Есть идея добавить информацию по лабораториям, которые исследуют старение. Показать, какие компетенции требуются для работы в этих лабораториях, и связать их с учебными материалами в репозитории.
